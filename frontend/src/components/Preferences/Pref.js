        ...
        <nav class="bg-white border-gray-200 dark:bg-gray-900">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="#" class="flex items-center">
                    <img class="w-8 h-8 rounded-full" src="https://img.icons8.com/color/1x/appointment-reminders.png" alt="user photo"/>
                ...
                <div class="flex items-center md:order-2">
                    <button type="button" class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                        <img class="w-9 h-9 rounded-full" src="https://img.icons8.com/bubbles/1x/user.png" alt="user photo"/>
                        <Engagespot apiKey="utej4379xjgikkr6hn7tm" userId="mathewvinukariath@gmail.com" />;
